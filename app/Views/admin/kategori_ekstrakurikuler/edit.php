...
<div class="form-group row">
	...
	<div class="col-6">
		<input type="text" name="nama_kategori_ekstrakurikuler" class="form-control" placeholder="Nama kategori ekstrakurikuler" value="<?php echo esc($kategori_ekstrakurikuler->nama_kategori_ekstrakurikuler) ?>" required>
...
<div class="form-group row">
	...
	<div class="col-8">
		<input type="file" name="gambar" class="form-control" placeholder="Gambar/ Logo" value="<?php echo esc($kategori_ekstrakurikuler->gambar) ?>">
	</div>
	<div class="col-1">
...
<div class="form-group row">
	...
	<div class="col-9">
		<textarea name="keterangan" placeholder="Keterangan" class="form-control"><?php echo esc($kategori_ekstrakurikuler->keterangan) ?></textarea>
	</div>
</div>
...
<div class="form-group row">
	...
	<div class="col-9">
		<input type="number" name="urutan" class="form-control" placeholder="Nomor urut tampil" value="<?php echo esc($kategori_ekstrakurikuler->urutan) ?>">
	</div>
</div>
