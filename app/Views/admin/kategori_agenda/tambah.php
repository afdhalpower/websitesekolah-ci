...
<?php echo form_open(base_url('admin/kategori_agenda')); ?>
<?php echo csrf_field(); ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Tambah Kategori Agenda</h4>
                ...
                <div class="form-section">
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_kategori_agenda" id="nama_kategori_agenda" class="form-control" placeholder="Nama kategori agenda" value="<?= set_value('nama_kategori_agenda') ?>" required>
                        </div>
                        <div class="form-group">
