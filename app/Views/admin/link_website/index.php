...
<table class="table table-bordered table-sm" id="example3">
	...
	<tbody>
		...
		<tr>
			...
			<td><?php echo esc($link_website->nama_link_website) ?>
				<small>
					<br><i class="fa fa-link"></i> <?php echo esc($link_website->link_website) ?>
					<br><i class="fa fa-globe"></i> <?php echo esc($link_website->metode_link) ?>
				</small>
			</td>
			<td><?php echo esc($link_website->keterangan) ?></td>
			<td>
				<?php if($link_website->status_link_website=='Publish') { ?>
					<span class="badge bg-info">
						<i class="fa fa-eye"></i> <?php echo esc($link_website->status_link_website) ?>
					</span>
				<?php }else{ ?>
			...
			<td class="text-center"><?php echo esc($link_website->urutan) ?></td>
			<td>
