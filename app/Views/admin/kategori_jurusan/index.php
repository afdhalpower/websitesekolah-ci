...
<table class="table table-bordered table-sm" id="example1">
	...
	<tbody>
		...
		<tr>
			...
			<td><?php echo esc($kategori_jurusan['nama_kategori_jurusan']) ?></td>
			<td><?php echo esc($kategori_jurusan['keterangan']) ?></td>
			<td><?php echo esc($kategori_jurusan['slug_kategori_jurusan']) ?></td>
			<td><?php echo esc($kategori_jurusan['urutan']) ?></td>
			<td>
