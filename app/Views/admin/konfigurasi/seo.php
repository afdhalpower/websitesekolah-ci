...
<div class="form-group row">
	...
	<div class="col-9">
		<textarea name="keywords" class="form-control"><?php echo esc($konfigurasi->keywords) ?></textarea>
	</div>
</div>
...
<div class="form-group row">
	...
	<div class="col-9">
		<textarea name="metatext" class="form-control"><?php echo esc($konfigurasi->metatext) ?></textarea>
	</div>
</div>
