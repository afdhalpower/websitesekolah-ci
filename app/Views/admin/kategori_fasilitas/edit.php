...
<div class="form-group row">
	...
	<div class="col-6">
		<input type="text" name="nama_kategori_fasilitas" class="form-control" placeholder="Nama kategori fasilitas" value="<?php echo esc($kategori_fasilitas->nama_kategori_fasilitas) ?>" required>
...
<div class="form-group row">
	...
	<div class="col-8">
		<input type="file" name="gambar" class="form-control" placeholder="Gambar/ Logo" value="<?php echo esc($kategori_fasilitas->gambar) ?>">
	</div>
	<div class="col-1">
...
<div class="form-group row">
	...
	<div class="col-9">
		<textarea name="keterangan" placeholder="Keterangan" class="form-control"><?php echo esc($kategori_fasilitas->keterangan) ?></textarea>
	</div>
</div>
...
<div class="form-group row">
	...
	<div class="col-9">
		<input type="number" name="urutan" class="form-control" placeholder="Nomor urut tampil" value="<?php echo esc($kategori_fasilitas->urutan) ?>">
	</div>
</div>
