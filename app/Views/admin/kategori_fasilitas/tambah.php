    ...
    <div class="modal-dialog">
        <div class="modal-content" style="border-radius:var(--radius-lg);overflow:hidden;">
            <div class="modal-header" style="background:var(--card);border-bottom:1px solid var(--border);padding:1rem 1.5rem;">
                <h5 class="modal-title" style="font-size:1rem;font-weight:600;"><i class="fas fa-plus-circle" style="color:var(--green);"></i> Tambah Kategori Fasilitas</h5>
                <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
            </div>
            <?php echo form_open(base_url('admin/kategori_fasilitas')); ?>
            <div class="modal-body" style="padding:1.5rem;">
                <div class="form-section">
                    <label class="form-label">Nama Kategori Fasilitas <span class="text-danger">*</span></label>
                    <input type="text" name="nama_kategori_fasilitas" class="form-control" value="<?= set_value('nama_kategori_fasilitas') ?>" required placeholder="Masukkan nama">
                </div>
