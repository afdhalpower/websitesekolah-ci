		...
		<div class="card">
			...
			<div class="card-body">
				...
				<div class="form-group row">
					...
					<div class="col-6">
						<input type="text" name="nama_siswa" class="form-control form-control-lg" placeholder="Nama lengkap siswa" value="<?php if(isset($_POST['nama_siswa'])) { echo set_value('nama_siswa'); }else{ echo esc($siswa->nama_siswa); } ?>" required>
				...
				<div class="form-group row">
					...
					<div class="col-6">
						<input type="text" name="nama_panggilan" class="form-control" placeholder="Nama panggilan" value="<?php if(isset($_POST['nama_panggilan'])) { echo set_value('nama_panggilan'); }else{ echo esc($siswa->nama_panggilan); } ?>">
				...
				<div class="form-group row">
					...
					<div class="col-3">
						<input type="text" name="nis" class="form-control" placeholder="Nomor Induk Siswa (NIS)" value="<?php if(isset($_POST['nis'])) { echo set_value('nis'); }else{ echo esc($siswa->nis); } ?>">
						<small class="text-secondary">Nomor Induk Siswa (NIS)</small>
					</div>
					<div class="col-3">
						<input type="text" name="nisn" class="form-control" placeholder="Nomor Induk Siswa Nasional (NISN)" value="<?php if(isset($_POST['nisn'])) { echo set_value('nisn'); }else{ echo esc($siswa->nisn); } ?>">
				...
				<div class="form-group row">
					...
					<div class="col-3">
						<input type="text" name="negara_asal" class="form-control" value="<?php if(isset($_POST['negara_asal'])) { echo set_value('negara_asal'); }else{ echo esc($siswa->negara_asal); } ?>" placeholder="Negara asal (jika WNA)">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-3">
						...
						<select name="id_hubungan" class="form-control select2">
							<?php foreach($hubungan as $hubungan) { ?>
								<option value="<?php echo esc($hubungan->id_hubungan) ?>" <?php if(set_value('id_hubungan')==$hubungan->id_hubungan) { echo 'selected'; }elseif($siswa->id_hubungan==$hubungan->id_hubungan) { echo 'selected'; } ?>>
					...
					<div class="col-2">
						<input type="number" name="anak_ke" class="form-control" placeholder="Anak nomor ke?" value="<?php if(isset($_POST['anak_ke'])) { echo set_value('anak_ke'); }else{ echo esc($siswa->anak_ke); } ?>" required>
						<small class="text-gray">Anak nomor ke</small>
					</div>
					<div class="col-2">
						<input type="number" name="jumlah_saudara" class="form-control" placeholder="Jumlah saudara" value="<?php if(isset($_POST['jumlah_saudara'])) { echo set_value('jumlah_saudara'); }else{ echo esc($siswa->jumlah_saudara); } ?>" required>
				...
				<div class="form-group row">
					...
					<div class="col-3">
						<input type="text" name="tempat_lahir" class="form-control" placeholder="Tempat lahir" value="<?php if(isset($_POST['tempat_lahir'])) { echo set_value('tempat_lahir'); }else{ echo esc($siswa->tempat_lahir); } ?>" required>
						<small class="text-secondary">Tempat lahir</small>
					</div>
					<div class="col-3">
						<input type="text" name="tanggal_lahir" class="form-control tanggal" placeholder="dd-mm-yyyy" value="<?php if(isset($_POST['tanggal_lahir'])) { echo set_value('tanggal_lahir'); }else{ echo esc($this->website->tanggal_id($siswa->tanggal_lahir)); } ?>" required>
				...
				<div class="form-group row">
					...
					<div class="col-9">
						<textarea name="alamat" placeholder="Alamat" class="form-control" required><?php if(isset($_POST['alamat'])) { echo set_value('alamat'); }else{ echo esc($siswa->alamat); } ?></textarea>
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-6">
						<input type="text" name="kode_pos" class="form-control" placeholder="Kode Pos" value="<?php if(isset($_POST['kode_pos'])) { echo set_value('kode_pos'); }else{ echo esc($siswa->kode_pos); } ?>">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-3">
						<input type="text" name="telepon" class="form-control" placeholder="Telepon/HP" value="<?php if(isset($_POST['telepon'])) { echo set_value('telepon'); }else{ echo esc($siswa->telepon); } ?>">
						<small class="text-secondary">Telepon/HP</small>
					</div>
					<div class="col-3">
						<input type="email" name="email" class="form-control" placeholder="Email" value="<?php if(isset($_POST['email'])) { echo set_value('email'); }else{ echo esc($siswa->email); } ?>">
				...
				<div class="form-group row">
					...
					<div class="col-6">
						<input type="file" name="gambar" class="form-control" placeholder="Gambar/Foto" value="<?php if(isset($_POST['nama_siswa'])) { echo set_value('gambar'); }else{ echo esc($siswa->gambar); } ?>">
					</div>
				</div>
		...
		<div class="card">
			...
			<div class="card-body">
					...
					<div class="col-6">
						...
						<select name="id_tahun" class="form-control select2" required>
							...
							<?php foreach($tahun as $tahun) { ?>
								<option value="<?php echo esc($tahun->id_tahun) ?>" <?php if(set_value('id_tahun')==$tahun->id_tahun) { echo 'selected'; }elseif($siswa->id_tahun==$tahun->id_tahun) { echo 'selected'; } ?>>
									<?php echo esc($tahun->tahun_mulai) ?>/<?php echo esc($tahun->tahun_selesai) ?> - <?php echo esc($tahun->nama_tahun) ?>
								</option>
							<?php } ?>
						</select>
					</div>
					...
					<div class="col-6">
						...
						<select name="id_jenjang" class="form-control select2" required>
							...
							<?php foreach($jenjang as $jenjang) { ?>
								<option value="<?php echo esc($jenjang->id_jenjang) ?>" <?php if(set_value('id_jenjang')==$jenjang->id_jenjang) { echo 'selected'; }elseif($siswa->id_jenjang==$jenjang->id_jenjang) { echo 'selected'; } ?>>
					...
					<div class="col-6">
						...
						<select name="id_kelas" class="form-control select2" required>
							...
							<?php foreach($kelas as $kelas) { ?>
								<option value="<?php echo esc($kelas->id_kelas) ?>" <?php if(set_value('id_kelas')==$kelas->id_kelas) { echo 'selected'; }elseif($siswa->id_kelas==$kelas->id_kelas) { echo 'selected'; } ?>>
									<?php echo esc($kelas->nama_jenjang) ?> - <?php echo esc($kelas->nama_kelas) ?>
								</option>
							<?php } ?>
						</select>
					</div>
				...
				<div class="form-group row">
					...
					<div class="col-6">
						<input type="text" name="tanggal_masuk" class="form-control tanggal" placeholder="Tanggal masuk" value="<?php if(isset($_POST['tanggal_masuk'])) { echo set_value('tanggal_masuk'); }else{ echo esc($this->website->tanggal_id($siswa->tanggal_masuk)); } ?>" required>
				...
				<div class="form-group row">
					...
					<div class="col-6">
						<input type="text" name="asal_sekolah" class="form-control" placeholder="Nama Sekolah Asal" value="<?php if(isset($_POST['asal_sekolah'])) { echo set_value('asal_sekolah'); }else{ echo esc($siswa->asal_sekolah); } ?>">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-6">
						<textarea name="alamat_sekolah_asal" class="form-control" placeholder="Alamat Sekolah Asal"><?php if(isset($_POST['alamat_sekolah_asal'])) { echo set_value('alamat_sekolah_asal'); }else{ echo esc($siswa->alamat_sekolah_asal); } ?></textarea>
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-6">
						<input type="text" name="tanggal_pindah" class="form-control tanggal" placeholder="Tanggal pindah" value="<?php if(isset($_POST['tanggal_pindah'])) { echo set_value('tanggal_pindah'); }else{ echo esc($this->website->tanggal_id($siswa->tanggal_pindah)); } ?>">
		...
		<div class="card">
			...
			<div class="card-body">
				...
				<div class="form-group row">
					...
					<div class="col-3">
						<input type="number" name="tinggi" class="form-control" placeholder="Tinggi Badan" value="<?php if(isset($_POST['tinggi'])) { echo set_value('tinggi'); }else{ echo esc($siswa->tinggi); } ?>">
						<small class="text-gray">Tinggi Badan dalam Centimeter</small>
					</div>
					<div class="col-3">
						<input type="number" name="berat" class="form-control" placeholder="Berat Badan" value="<?php if(isset($_POST['berat'])) { echo set_value('berat'); }else{ echo esc($siswa->berat); } ?>">
				...
				<div class="form-group row">
					...
					<div class="col-6">
						<textarea name="penyakit_siswa" class="form-control" placeholder="Penyakit yang pernah/sedang diderita Siswa"><?php if(isset($_POST['penyakit_siswa'])) { echo set_value('penyakit_siswa'); }else{ echo esc($siswa->penyakit_siswa); } ?></textarea>
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-6">
						<textarea name="hobi_siswa" class="form-control" placeholder="Hobi siswa"><?php if(isset($_POST['hobi_siswa'])) { echo set_value('hobi_siswa'); }else{ echo esc($siswa->hobi_siswa); } ?></textarea>
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-6">
						<textarea name="isi" class="form-control" placeholder="Deskripsi Ringkas Tentang Siswa"><?php if(isset($_POST['isi'])) { echo set_value('isi'); }else{ echo esc($siswa->isi); } ?></textarea>
		...
		<div class="card">
			...
			<div class="card-body">
				...
				<div class="form-group row">
					...
					<div class="col-6">
						<input type="text" name="nama_ayah" class="form-control" placeholder="Nama Ayah" value="<?php if(isset($_POST['nama_ayah'])) { echo set_value('nama_ayah'); }else{ echo esc($siswa->nama_ayah); } ?>">
				...
				<div class="form-group row">
					...
					<div class="col-6">
						...
						<select name="id_agama_ayah" class="form-control select2">
							...
							<?php foreach($agama as $agama) { ?>
								<option value="<?php echo esc($agama->id_agama) ?>" <?php if(set_value('id_agama_ayah')==$agama->id_agama) { echo 'selected'; }elseif($siswa->id_agama_ayah==$agama->id_agama) { echo 'selected'; } ?>>
									<?php echo esc($agama->nama_agama) ?>
								</option>
							<?php } ?>
						</select>
					...
					<div class="col-6">
						...
						<select name="id_pekerjaan_ayah" class="form-control select2">
							...
							<?php foreach($pekerjaan as $pekerjaan) { ?>
								<option value="<?php echo esc($pekerjaan->id_pekerjaan) ?>" <?php if(set_value('id_pekerjaan_ayah')==$pekerjaan->id_pekerjaan) { echo 'selected'; }elseif($siswa->id_pekerjaan_ayah==$pekerjaan->id_pekerjaan) { echo 'selected'; } ?>>
				...
				<div class="form-group row">
					...
					<div class="col-6">
						...
						<select name="id_jenjang_ayah" class="form-control select2">
							...
							<?php foreach($jenjang as $jenjang) { ?>
								<option value="<?php echo esc($jenjang->id_jenjang) ?>" <?php if(set_value('id_jenjang_ayah')==$jenjang->id_jenjang) { echo 'selected'; }elseif($siswa->id_jenjang_ayah==$jenjang->id_jenjang) { echo 'selected'; } ?>>
									<?php echo esc($jenjang->nama_jenjang) ?>
								</option>
							<?php } ?>
						</select>
				...
				<div class="form-group row">
					...
					<div class="col-6">
						<textarea name="alamat_ayah" placeholder="Alamat Ayah" class="form-control"><?php if(isset($_POST['alamat_ayah'])) { echo set_value('alamat_ayah'); }else{ echo esc($siswa->alamat_ayah); } ?></textarea>
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-6">
						<input type="text" name="telepon_ayah" class="form-control" placeholder="Telepon/HP Ayah" value="<?php if(isset($_POST['telepon_ayah'])) { echo set_value('telepon_ayah'); }else{ echo esc($siswa->telepon_ayah); } ?>">
					</div>
				</div>
		...
		<div class="card">
			...
			<div class="card-body">
				...
				<div class="form-group row">
					...
					<div class="col-6">
						<input type="text" name="nama_ibu" class="form-control" placeholder="Nama Ibu" value="<?php if(isset($_POST['nama_ibu'])) { echo set_value('nama_ibu'); }else{ echo esc($siswa->nama_ibu); } ?>">
				...
				<div class="form-group row">
					...
					<div class="col-6">
						...
						<select name="id_agama_ibu" class="form-control select2">
							<option value="">Pilih Agama</option>
							<?php foreach($agama as $agama) { ?>
								<option value="<?php echo esc($agama->id_agama) ?>" <?php if(set_value('id_agama_ibu')==$agama->id_agama) { echo 'selected'; }elseif($siswa->id_agama_ibu==$agama->id_agama) { echo 'selected'; } ?>>
									<?php echo esc($agama->nama_agama) ?>
								</option>
							<?php } ?>
						</select>
				...
				<div class="form-group row">
					...
					<div class="col-6">
						...
						<select name="id_pekerjaan_ibu" class="form-control select2">
							<option value="">Pilih Pekerjaan</option>
							<?php foreach($pekerjaan as $pekerjaan) { ?>
								<option value="<?php echo esc($pekerjaan->id_pekerjaan) ?>" <?php if(set_value('id_pekerjaan_ibu')==$pekerjaan->id_pekerjaan) { echo 'selected'; }elseif($siswa->id_pekerjaan_ibu==$pekerjaan->id_pekerjaan) { echo 'selected'; } ?>>
									<?php echo esc($pekerjaan->nama_pekerjaan) ?>
								</option>
							<?php } ?>
						</select>
				...
				<div class="form-group row">
					...
					<div class="col-6">
						...
						<select name="id_jenjang_ibu" class="form-control select2">
							<option value="">Pilih Jenjang Pendidikan</option>
							<?php foreach($jenjang as $jenjang) { ?>
								<option value="<?php echo esc($jenjang->id_jenjang) ?>" <?php if(set_value('id_jenjang_ibu')==$jenjang->id_jenjang) { echo 'selected'; }elseif($siswa->id_jenjang_ibu==$jenjang->id_jenjang) { echo 'selected'; } ?>>
									<?php echo esc($jenjang->nama_jenjang) ?>
								</option>
							<?php } ?>
						</select>
				...
				<div class="form-group row">
					...
					<div class="col-6">
						<textarea name="alamat_ibu" placeholder="Alamat Ibu" class="form-control"><?php if(isset($_POST['alamat_ibu'])) { echo set_value('alamat_ibu'); }else{ echo esc($siswa->alamat_ibu); } ?></textarea>
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-6">
						<input type="text" name="telepon_ibu" class="form-control" placeholder="Telepon/HP Ibu" value="<?php if(isset($_POST['telepon_ibu'])) { echo set_value('telepon_ibu'); }else{ echo esc($siswa->telepon_ibu); } ?>">
					</div>
				</div>
			...
			<div class="card-body">
				...
				<div id="myDIV">
					...
					<div class="form-group row">
						...
						<div class="col-6">
							<input type="text" name="nama_wali" class="form-control" placeholder="Nama Wali" value="<?php if(isset($_POST['nama_wali'])) { echo set_value('nama_wali'); }else{ echo esc($siswa->nama_wali); } ?>">
					...
					<div class="form-group row">
						...
						<div class="col-6">
							...
							<select name="id_agama_wali" class="form-control select2">
								<option value="">Pilih Agama</option>
								<?php foreach($agama as $agama) { ?>
									<option value="<?php echo esc($agama->id_agama) ?>" <?php if(set_value('id_agama_wali')==$agama->id_agama) { echo 'selected'; }elseif($siswa->id_agama_wali==$agama->id_agama) { echo 'selected'; } ?>>
										<?php echo esc($agama->nama_agama) ?>
									</option>
								<?php } ?>
							</select>
					...
					<div class="form-group row">
						...
						<div class="col-6">
							...
							<select name="id_pekerjaan_wali" class="form-control select2">
								<option value="">Pilih Pekerjaan</option>
								<?php foreach($pekerjaan as $pekerjaan) { ?>
									<option value="<?php echo esc($pekerjaan->id_pekerjaan) ?>" <?php if(set_value('id_pekerjaan_wali')==$pekerjaan->id_pekerjaan) { echo 'selected'; }elseif($siswa->id_pekerjaan_wali==$pekerjaan->id_pekerjaan) { echo 'selected'; } ?>>
										<?php echo esc($pekerjaan->nama_pekerjaan) ?>
									</option>
								<?php } ?>
							</select>
					...
					<div class="form-group row">
						...
						<div class="col-6">
							...
							<select name="id_jenjang_wali" class="form-control select2">
								<option value="">Pilih Jenjang Pendidikan</option>
								<?php foreach($jenjang as $jenjang) { ?>
									<option value="<?php echo esc($jenjang->id_jenjang) ?>"  <?php if(set_value('id_jenjang_wali')==$jenjang->id_jenjang) { echo 'selected'; }elseif($siswa->id_jenjang_wali==$jenjang->id_jenjang) { echo 'selected'; } ?>>
										<?php echo esc($jenjang->nama_jenjang) ?>
									</option>
								<?php } ?>
							</select>
					...
					<div class="form-group row">
						...
						<div class="col-6">
							<textarea name="alamat_wali" placeholder="Alamat Wali" class="form-control"><?php if(isset($_POST['alamat_wali'])) { echo set_value('alamat_wali'); }else{ echo esc($siswa->alamat_wali); } ?></textarea>
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-6">
							<input type="text" name="telepon_wali" class="form-control" placeholder="Telepon/HP Wali" value="<?php if(isset($_POST['telepon_wali'])) { echo set_value('telepon_wali'); }else{ echo esc($siswa->telepon_wali); } ?>">
						</div>
					</div>
				</div>
