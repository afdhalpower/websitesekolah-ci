...
<div class="modal-basic modal fade show" id="DetailMenu<?php echo esc($menu->id_menu) ?>" tabindex="-1" role="dialog" aria-hidden="true">
		...
		<div class="modal-content modal-bg-white ">
			...
			<div class="modal-body">
				...
				<?php foreach($sub_menu as $sub_menu) { ?>
					<tr>
						<td><strong><?php echo esc($sub_menu->nama_sub_menu) ?></strong>
							<br><small>
								<i class="fa fa-link"></i> <?php echo esc($sub_menu->link) ?>
								<br><i class="fa fa-newspaper"></i> <?php echo esc($sub_menu->keterangan) ?></small>
						</td>
						<td>
							<?php if($sub_menu->status_sub_menu=='Publish') { ?>
								<span class="badge bg-info">
									<i class="fa fa-eye"></i> <?php echo esc($sub_menu->status_sub_menu) ?>
								</span>
							<?php }else{ ?>
						...
						<td><?php echo esc($sub_menu->urutan) ?></td>
						<td>
