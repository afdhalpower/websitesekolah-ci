...
?>
				<div class="form-group row">
					...
					<div class="col-9">
						<input type="text" name="nama_menu" class="form-control" placeholder="Nama menu" value="<?php echo esc($menu->nama_menu) ?>" required>
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-9">
						<input type="text" name="link" class="form-control" placeholder="Alamat/link menu" value="<?php echo esc($menu->link) ?>" required>
				...
				<div class="form-group row">
					...
					<div class="col-9">
						<input type="text" name="icon" class="form-control" placeholder="Icon menu" value="<?php echo esc($menu->icon) ?>">
				...
				<div class="form-group row">
					...
					<div class="col-9">
						<input type="number" name="urutan" class="form-control" placeholder="Nomor urut" value="<?php echo esc($menu->urutan) ?>">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-9">
						<textarea class="form-control" name="keterangan" placeholder="Keterangan"><?php echo esc($menu->keterangan) ?></textarea>
					</div>
				</div>
