<!-- Main Sidebar Container -->
  <aside class="main-sidebar sidebar-dark-lightblue elevation-4">
    ...
    <a href="<?php echo base_url('admin/dasbor') ?>" class="brand-link">
      <img src="<?php echo esc($this->website->icon()) ?>" alt="<?php echo esc($this->website->namaweb()) ?>" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light"><?php echo esc($this->website->singkatan()) ?></span>
    </a>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <!-- <div class="card-header">
                <h3 class="card-title"><?php echo esc($title) ?></h3>
