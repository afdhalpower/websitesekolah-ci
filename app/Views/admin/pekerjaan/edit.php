...
<div class="form-group row">
	...
	<div class="col-9">
		<input type="text" name="nama_pekerjaan" class="form-control" placeholder="Nama pekerjaan" value="<?php echo esc($pekerjaan->nama_pekerjaan) ?>" required>
	</div>
</div>
...
<div class="form-group row">
	...
	<div class="col-9">
		<input type="number" name="urutan" class="form-control" placeholder="Urutan" value="<?php echo esc($pekerjaan->urutan) ?>" required>
	</div>
</div>
