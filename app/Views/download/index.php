            ...
            <div class="blog classic-view pt-10">
                ...
                <table class="table table-sm table-bordered tabelku" id="example2">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-center"><?php echo esc($no) ?>
                            </td>
                            
                            <td><?php echo esc($download->judul_download) ?>
                                <small>
                                    <br><?php echo esc($download->isi) ?>
                                </small>
                            </td>
                            <td class="text-center"><?php echo strtoupper($download->file_ext) ?></td>
                            <td class="text-center"><?php echo esc($download->file_size) ?> MB</td>
                            <td class="text-center"><?php echo esc($download->hits) ?> kali</td>
                            <td>
