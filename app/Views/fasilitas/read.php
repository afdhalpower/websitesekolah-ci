              ...
              <table class="table table-bordered tabelku">
                <thead>
                  <tr>
                    ...
                    <th><?php echo esc($fasilitas->judul_fasilitas) ?></th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo esc($fasilitas->kondisi_fasilitas) ?></td>
                  </tr>
                  <tr>
                    <td class="bg-light">Kategori</td>
                    <td><?php echo esc($fasilitas->nama_kategori_fasilitas) ?></td>
                  </tr>
                  
                  
                </tbody>
              </table>
              <?php echo esc($fasilitas->isi) ?>
            </div>
            <div class="card-footer">
              Tanggal: <?php echo esc($this->website->tanggal_bulan_menit($fasilitas->tanggal)) ?>
            </div>
          </div>
              ...
              <div class="card">
                <figure class="card-img-top">
                  <a href="<?php echo base_url('fasilitas/read/'.$fasilitas->slug_fasilitas) ?>">
                    <img class="img-fluid" src="<?php echo base_url('assets/upload/image/'.$fasilitas->gambar) ?>" srcset="<?php echo base_url('assets/upload/image/'.$fasilitas->gambar) ?> 2x" alt="<?php echo esc($fasilitas->judul_fasilitas) ?>" />
                  </a>
                </figure>
                <div class="card-body px-6 py-5">
                  <h5 class="mb-1">
                    <a href="<?php echo base_url('fasilitas/read/'.$fasilitas->slug_fasilitas) ?>">
                      <?php echo esc($fasilitas->judul_fasilitas) ?>
                    </a>
                  </h5>
                  <p class="mb-0"><?php echo esc($fasilitas->nama_kategori_fasilitas) ?> | <?php echo esc($fasilitas->kondisi_fasilitas) ?></p>
                </div>
                <!--/.card-body -->
              </div>
              <!-- /.card -->
