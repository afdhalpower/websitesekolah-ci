<section class="wrapper bg-light">
  <div class="container-card">
    <div class="card image-wrapper bg-full bg-image mt-2 mb-0" data-image-src="<?php echo esc($this->website->banner()) ?>">
        ...
        <div class="container">
          <div class="row gx-md-8 gx-xl-12 gy-10 align-items-center text-center text-lg-start">
            <div class="col-lg-6" data-cues="slideInDown" data-group="page-title" data-delay="900">
              <h1 class="display-4 mb-4 me-xl-5 me-xxl-0 text-haqi"><?php echo esc($slider->judul_galeri) ?></h1>
              <p class="lead fs-23 lh-sm mb-7 pe-xxl-15 text-white"><?php echo strip_tags($slider->isi) ?></p>
              <div>
                <a href="<?php echo esc($slider->website) ?>" class="btn btn-lg btn-primary rounded">
                  <?php echo esc($slider->text_website) ?> &nbsp;<i class="fa fa-arrow-right ml-2"></i>
                </a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="ratio ratio-16x9 rounded shadow-lg border border-secondary p-2">
          <iframe src="https://www.youtube.com/embed/<?php echo esc($site->link_video) ?>" title="<?php echo esc($this->website->namaweb()) ?>" allowfullscreen></iframe>
      </div>
      </div>
