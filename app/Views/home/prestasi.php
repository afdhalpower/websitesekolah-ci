<!-- /section -->
    <section id="snippet-1" class="wrapper bg-primary text-white wrapper-border">
      <div class="container pt-10 pt-md-15 pb-13 pb-md-15">
        ...
        <p class="lead fs-lg mb-10 text-center px-md-16 px-lg-21 px-xl-0"><?php echo esc($this->website->namaweb()) ?></p>
                ...
                <article>
                  ...
                  <div class="post-header">
                    <div class="post-category text-line text-warning">
                      <a href="<?php echo base_url('prestasi/kategori/'.$prestasi->slug_kategori_prestasi) ?>" class="hover text-warning" rel="category"><?php echo esc($prestasi->nama_kategori_prestasi) ?></a>
                    </div>
                    <!-- /.post-category -->
                    <h2 class="post-title h3 mt-1 mb-3">
                      <a class="link-light" href="<?php echo base_url('prestasi/read/'.$prestasi->slug_prestasi) ?>"><?php echo esc($prestasi->judul_prestasi) ?></a>
                    </h2>
                  </div>
