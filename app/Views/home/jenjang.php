  ...
  <div class="container pt-3 pt-md-6">
        <div class="px-lg-5 mb-4 mb-md-6">
            <div class="row gx-0 gx-md-8 gx-xl-12 gy-8 justify-content-center">
              ...
              <h2 class="fs-16 text-uppercase mb-3 text-gradient gradient-1">Tentang <?php echo esc($this->website->namaweb()) ?></h2>
              <h4 class="display-6 text-center px-xl-10 px-xxl-15 mb-10"><?php echo esc($site->deskripsi) ?></h3>
